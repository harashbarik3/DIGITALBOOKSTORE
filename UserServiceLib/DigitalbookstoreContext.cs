...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ASHALATA\\SQLEXPRESS; Initial Catalog=DIGITALBOOKSTORE; User ID=sa; Password=password123;TrustServerCertificate=True; ");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Book>(entity =>
        {
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Books)
                ...
                .HasConstraintName("FK__Book__CategoryId__412EB0B6");
        ...
        modelBuilder.Entity<Subscription>(entity =>
        {
            ...
            entity.HasOne(d => d.Book).WithMany(p => p.Subscriptions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Subscript__BookI__440B1D61");
